...
private:
    ...
    static std::vector<std::pair<int, int> > paintStencil1;
    static std::vector<std::pair<int, int> > paintStencil2;
    static std::vector<std::pair<int, int> > paintStencil3;
    static std::vector<std::pair<int, int> > paintStencil4;
    static std::vector<std::pair<int, int> > paintStencil5;
    static std::vector<std::vector<std::pair<int, int>>*> paintStencil;
